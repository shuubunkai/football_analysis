        ...
        for object,object_tracks in tracks.items():
            ...
            for frame_num in range(0,number_of_frames,self.frame_window):
                ...
                for track_id,_ in object_tracks[frame_num].items():
                    ...
                    speeed_M_S = distance_covered / time_elapsed if time_elapsed > 0 else 0
                    speed_km_hr = speeed_M_S * 3.6
                    ...
                    for frame_num_batch in range(frame_num,last_frame):
                        ...
                        object_tracks[frame_num_batch][track_id]['speed'] = speed_km_hr
            ...
            for object, object_tracks in tracks.items():
                 ...
                 for track_id, track_info in object_tracks[frame_num].items():
                     if "speed" in track_info:
                          ...
                          cv2.putText(frame,f"Distance: {distance:.2f} m",(position[0],position[1]+20)  , cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
